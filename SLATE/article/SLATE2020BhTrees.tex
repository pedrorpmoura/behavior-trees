...
We chose this language due to our previous experience with it, and also due to its simplicity.
...
\bht\ language was mentioned along the paper. %%FIXME: WTH! We demand explanation!

\subsection{Future Work}
As future work we intend to implement the generate of code for other programming languages, such as Java and C++ so that it can be widely used by the game development community.
