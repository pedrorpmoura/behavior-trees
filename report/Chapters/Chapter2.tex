...
\paragraph{Probability Selector}{
    ...
    \centering
        ...
        \begin{align*}
            ...
            P_2 &= 1 - \frac{C}{10}
        \end{align*}
        onde $C \in [0,10]$ é um valor que representa o nível de coragem do NPC.
    \end{figure}
    ...
    Mesmo não sendo muito correto (porque não sabemos que fatores levam à existência desta possibilidade), é uma aproximação interessante à tal imprevisibilidade que existe na vida real, que permite a criação de comportamentos ainda mais complexos, utilizando variáveis como o $C$, que são criadas pelo próprio programador.
