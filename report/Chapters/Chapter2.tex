...
\paragraph{Probability Selector}{
    ...
    \paragraph{\textit{NOTA:}}{
        \textit{
        Com este novo nodo, atingimos um novo nível de AI, pois permite-nos construir comportamentos não só mais imprevisíveis, como também influenciados por fatores externos.
